...
import docimg from '../assets/image.png'
  ...
  return (
    <div className='flex justify-around '>
      <div className=' flex h-screen w-screen items-center p-4 bg-[#16202a]'>
        ...
        <div className="w-[50%] max-w-lg p-8 space-y-6 rounded-lg shadow-lg text-white bg-[#16202a] ">
      ...
      <img src={docimg} className='h-screen w-[65vw]' />
    </div>
  )
}

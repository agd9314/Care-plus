...
export const DoctorCard = ({
    ...
    return (
        <div className="rounded-lg p-4 bg-white px-8">
            <div className="flex items-center gap-2">
                ...
                <div>
                    <div className="flex items-center gap-2 text-lg">
                        ...
                        <div className="flex items-center"><span>{starValue}</span>
                            <svg
                    ...
                    <h2 className="text-sm">Address : {address || "chitkara university"}</h2>
                </div>
            </div>
